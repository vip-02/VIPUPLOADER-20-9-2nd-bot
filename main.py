...
@bot.on_message(filters.command(["omkar"]))    
async def account_login(bot: Client, m: Message):    
    ...
    try:    
        for i in range(count - 1, len(links)):
            ...
            elif "edge.api.brightcove.com" in url:eyJ0eXAiOiJKV
                bcov = 'bcov_auth=eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..Pc87bmMz8Pm1Z1FtFqzrABbi8DsMCOy5tB_K8g1a7tO1yr3J8_8TDrFrNMaFLzXMorAoOB4xmsjOIzTkkdinzXzb8-gD-PrLkGyi5gzjO_mF-Bqjhxbvkk-274VXsGHdE15Idc7EtOvYgUr-1PAV-ceLF14PLYipGUcQaFayUEczDyPr8HkhL3QNHZyBbQRIPTt2dzOioN09xXze5tkRxR1UtIRrvmNvI5oa-FR5IWqp_S-BI_JypNvgXuZYcrzxE84IGDYufsx5QKRScQzWh4wclEOTMPd3Jfit2WUkf1VbiokWtrI33Hr7Jkr0cV0QmH9EFk-fyTxmmc7OHypetw'
            ...
            try:
                ...
                await m.reply_text(
                    f"**downloading failed [😎FNC_OmKaR:)™]**\n{str(e)}\n**Name** - {name}\n**Link** - `{url}`\n\n═════━‧₊˚❀༉‧₊˚.━═════"
                    )
